...
// WritePty sends input bytes to the PTY's stdin. Plain pass-through;
// the frontend's IME compositionend handler hands us already-composed
// Korean syllables, so the long chain of jamo coalescers / NFC /
// streaming composers we built between v0.9.0 and v0.9.48 was the
